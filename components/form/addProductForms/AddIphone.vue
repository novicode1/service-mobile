    ...
    <div class="content-wrapper">
      <label class="input-field" :class="{ 'input-field-error': $v.name.$error }">
        ...
        <input
          ...
          placeholder="iPhone Xs 64/256/512GB"
        >
      ...
      <div class="option-add" v-for="(option, index) in options" :key="option+index">
        <label class="input-field">
          <span class="label-text">Память:</span>
          <input v-model="options[index].optionName" placeholder="256gb">
        </label>
        ...
        >
          <label class="input-field">
            ...
            <input v-model="options[index].optionsList[optionIndex].name" placeholder="Space Gray">
          </label>

          <label class="input-field">
            <span class="label-text">Цвет в HEX формате:</span>
            <input
              v-model="options[index].optionsList[optionIndex].color"
              type="color"
              placeholder="#333444"
            >
          </label>
          ...
          <label class="input-field">
            ...
            <input
              v-model="options[index].optionsList[optionIndex].price"
              type="number"
              placeholder="1099"
            >
          </label>
  ...
  methods: {
    ...
    onCreateProduct() {
      ...
      if (!this.image || fileType === "image/webp") {
        alert(
          "Вы загрузили неверную картинку. Формат должен быть в .jpg или .jpeg или .png"
        );
        return;
      }
      const productData = {
