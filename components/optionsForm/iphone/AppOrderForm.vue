  ...
  <form @submit.prevent="onCreateProduct" novalidate class="order-form">
    ...
    <div class="content-wrapper">
      <label class="input-field" :class="{ 'input-field-error': $v.tel.$error }">
        ...
        >Минимально {{$v.tel.$params.minLength.min}} цифр.</span>
      </label>
    ...
    onCreateProduct() {
      ...
      if (this.productDetails.name) {
        options =
          ...
          "$ " +
          this.$store.getters.usd.toFixed() * this.productDetails.currentPrice +
          "грн" +
          "\n- Цвет: " +
      ...
      this.$axios
        .post(
          "https://api.telegram.org/bot709794055:AAHXeUUQe1R4O3FEGMoH1ONsQtUlVO0FTRE/sendMessage",
          {
            chat_id: "-260327413",
            text: comment,
            parse_mode: "HTML"
