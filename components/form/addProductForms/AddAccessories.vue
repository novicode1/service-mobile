    ...
    <form @submit.prevent="onCreateProduct" novalidate class="add-product-form">
        <div class="content-wrapper">
            <label class="input-field" :class="{ 'input-field-error': $v.name.$error }">
                Название
                <input v-model.trim="name" @input="setName($event.target.value)" placeholder="iPhone XS Leather Case"/>
            ...
            <div class="option-add">
                <div class="sub-option" v-for="(option, index) in options" :key="option+index">
                    <label class="input-field">
